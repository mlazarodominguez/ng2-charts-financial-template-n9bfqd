...
import { AppChartMetaConfig, FinancialDataSet, ChartOptions, ChartType, Color, Label, BaseChartDirective } from './app-chart-config';
...
export class AppComponent  {
  ...
  update() {
    this.financialChartData[0].data = this.getRandomData(this.initialDateStr, this.barCount);
    this.financialChartType = this.financialChartType === 'ohlc' ?  'candlestick' : 'ohlc';
  }
}
